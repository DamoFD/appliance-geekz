    ...
    <main>
        <div class="relative z-[2] p-4 md:p-12 lg:p-8 w-full h-screen flex flex-col lg:flex-row lg:items-center justify-center items-start max-w-7xl mx-auto">
            ...
            <div class="mt-10 relative mx-auto">
                <img alt="washer" src={{ asset('images/washer.webp') }} class="w-full max-w-[500px]"/>
        ...
        <img alt="hero-background" class="absolute top-0 left-0 w-full h-screen object-cover" src={{ asset('images/hero-image.webp') }} />
